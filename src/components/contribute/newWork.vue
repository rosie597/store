...
<template>
  <div class="home">
      ...
      <div class="main">
        ...
        <div class="part2">
          ...
          <div class="imgInputerBox">
            ...
            <div class="imgInputerWrapper" v-for="(item, index) in workData.content">
              ...
              <span class="deleteWork" @click="deleteWork(index)" v-show="workData.content.length > 1 && item.url">×</span>
            </div>
          </div>
        </div>
        <div class="part3">
    ...
    <b-modal ref="imgTypeError" hide-footer hide-header>请上传正确的图片</b-modal>
